...
import (
	...
	payment "saga-pattern-choreography/payment-service/api"
)
...
func RunServerCMD() error {
	...
	// get configuration
	var cfg Config
	flag.StringVar(&cfg.GRPCPort, "grpc-port", "3001", "gRPC port to bind")
	...
	flag.StringVar(&cfg.DatastoreDBSchema, "db-schema", "payment_service", "Database schema")
	flag.Parse()
	...
	v1API := payment.NewPaymentServiceServer(db)
